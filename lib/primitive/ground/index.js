...
import { vcMixin, geometryInstances, appearance, show, interleave, releaseGeometryInstances, aaMixin, classificationType, debugShowBoundingVolume, debugShowShadowVolume } from '../../mixins/mixinProps';
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return Cesium.GroundPrimitive.initializeTerrainHeights();
...
var GroundPrimitive = __vue_normalize__({}, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__);
